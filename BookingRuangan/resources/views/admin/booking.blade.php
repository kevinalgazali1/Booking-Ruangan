<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-0">
        <div class="glass-effect rounded-2xl shadow-2xl overflow-hidden animate-slide-in z-0">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-6">
                ...
                <p class="text-purple-100 mt-1">Kelola semua booking ruangan</p>
            </div>
                        ...
                        @forelse($bookings as $booking)
                            <tr class="hover:bg-purple-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    @if ($booking->status === 'pending')
                                        <div class="flex gap-2">
                                            <form action="{{ route('booking.updateStatus', $booking->id) }}" method="POST">
                                                ...
                                                <button class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition font-medium">
                                                    ✓ Setuju
                                                </button>
                                            </form>
                                            <form action="{{ route('booking.updateStatus', $booking->id) }}" method="POST">
                                    ...
                                    @else
                                        <span class="text-gray-400 italic text-sm">Selesai diproses</span>
                                    @endif
                                </td>
                            </tr>
                        @empty
